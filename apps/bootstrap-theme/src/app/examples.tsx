...
export const Examples = [
...

  {
    ...
    content: (
      <figure className="figure">
        <img src="assets/images/engineer_288x288.gif" className="figure-img img-fluid rounded" alt="..." />
...

  {
    ...
    content: (
      <div>
      <table className="table-primary"><tbody>
      <tr className="table-primary">
        <td className="table-primary">...</td>
        </tr>
      </tbody></table>
      <table className="table-secondary"><tbody>
      <tr className="table-secondary">
      <td className="table-secondary">...</td>
        </tr>
      </tbody></table>
      <table className="table-success"><tbody>
        <tr className="table-success">
        <td className="table-success">...</td>
          </tr>
      </tbody></table>
      <table className="table-danger"><tbody>
      <tr className="table-danger">
      <td className="table-danger">...</td>
        </tr>
        </tbody></table>
      <table className="table-warning"><tbody>
      <tr className="table-warning">
      <td className="table-warning">...</td>
        </tr>
        </tbody></table>
      <table className="table-info"><tbody>
      <tr className="table-info">
      <td className="table-info">...</td>
        </tr>
        </tbody></table>
      <table className="table-light"><tbody>
      <tr className="table-light">
      <td className="table-light">...</td>
        </tr>
        </tbody></table>
      <table className="table-dark"><tbody>
  ...
  },
  {
    ...
    content: (
      <div className="text-center">
        <img src="assets/images/engineer_288x288.gif" className="rounded" alt="image_" />
      </div>
    ),
  },
